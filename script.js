...
(function () {
  const translations = {
    en: {
      ...
      'section-services': '02 — Services',
      'services-title':   'Let\'s Build Something',
      'services-sub':     'From data dashboards to digital products — here\'s what I can do for you.',
      'svc-name-2':  'Custom BI Dashboard',
      'svc-desc-2':  'Tailored dashboards in Power BI, Tableau, or Looker Studio — turning raw data into clear decisions.',
      'svc-name-4':  'Power BI, Tableau & Looker Workshop',
      'svc-desc-4':  'Hands-on group or private sessions in Power BI, Tableau & Looker Studio — from zero to dashboard in one day.',
      'svc-name-5':  'Excel & Spreadsheet Custom',
      'svc-desc-5':  'Automation, formulas, and structure — built exactly to your workflow.',
      'svc-name-6':  'Speaker Online / Offline',
      'svc-desc-6':  'Available for talks, webinars & workshops. Let\'s make it count.',
      'svc-name-7':  'System Design Custom',
      'svc-desc-7':  'From business requirements to interactive Figma prototypes — structured and precise.',
      'svc-name-9':  'Landing Page',
      'svc-desc-9':  'Clean, fast, and focused pages that make a strong first impression.',
      'svc-name-10': 'Social Media Design',
      'svc-desc-10': 'Visual content that stops the scroll and speaks your brand.',
      'svc-name-11': 'UI Mockup',
      'svc-desc-11': 'High-fidelity UI mockups that bring your product vision to life before a single line of code.',
      'section-skills':   '03 — Skills',
      'skills-title':     'Tools of the Trade',
      'skills-sub':       'The tools I reach for every day to turn ideas into outcomes.',
      'section-exp':      '04 — Experience',
      'exp-title':        'The Road Taken',
      'exp-sub':          'Every role shaped the way I think, build, and lead.',
      'exp-present':      'Present',
      'section-org':      '05 — Leadership',
      'org-title':        'Organizational Experience',
      'org-sub':          'Beyond titles — I\'ve built teams, run programs, and learned how people actually work.',
      ...
      'section-achieve':  '06 — Achievements',
      'achieve-title':    'Recognition & Awards',
      'achieve-sub':      'A few moments where the work spoke for itself.',
      'section-edu':      '07 — Education',
      'edu-title':        'Academic Background',
      'edu-sub':          'Where curiosity became discipline.',
      'section-works':    '08 — Selected Works',
      'works-title':      'Dashboards & Tools I Built',
      'section-portfolio':'09 — Portfolio',
      'portfolio-title':  'I Design, Too.',
      'portfolio-sub':    'UI/UX, brand identity, visual systems — built with the same precision I bring to data.',
      'portfolio-link':   'View on Behance ↗',
      'section-writing':  '10 — Writing',
      'writing-title':    'Things Worth Writing',
      'writing-sub':      'Long-form thoughts on design, data, career, and things I\'ve lived through.',
      'writing-link':     'Read on Medium ↗',
      'section-videos':   '11 — Videos',
      'videos-title':     'Talking Head',
      'videos-sub':       'When I\'m not building things, I talk about them — productivity, people, and life.',
      'videos-link':      'Watch on YouTube ↗',
      'section-techstack':'12 — Tech Stack',
      'techstack-title':  'What Runs Me',
      'techstack-sub':    'Not just tools — a carefully chosen stack that gets things done.',
      'section-contact':  '13 — Contact',
      'contact-title':    'Drop a Line',
      'contact-sub':      'Whether it\'s a project, a collab, or just curiosity — my inbox is always open.',
    ...
    id: {
      ...
      'section-services': '02 — Layanan',
      'services-title':   'Jasa yang Saya Tawarkan',
      'services-sub':     'Dari dashboard data hingga produk digital — ini yang bisa saya lakukan untuk Anda.',
      'svc-name-2':  'Dashboard BI Custom',
      'svc-desc-2':  'Dashboard yang disesuaikan di Power BI, Tableau, atau Looker — mengubah data mentah jadi keputusan yang tepat.',
      'svc-name-4':  'Workshop Power BI, Tableau & Looker',
      'svc-desc-4':  'Sesi kelompok atau privat langsung praktik di Power BI, Tableau & Looker Studio — dari nol hingga dashboard dalam satu hari.',
      'svc-name-5':  'Excel & Spreadsheet Custom',
      'svc-desc-5':  'Otomasi, formula, dan struktur — dibangun persis sesuai alur kerja Anda.',
      'svc-name-6':  'Pembicara Online / Offline',
      'svc-desc-6':  'Tersedia untuk seminar, webinar & workshop. Yuk wujudkan bersama.',
      'svc-name-7':  'Desain Sistem Custom',
      'svc-desc-7':  'Dari kebutuhan bisnis hingga prototipe Figma interaktif — terstruktur dan presisi.',
      'svc-name-9':  'Landing Page',
      'svc-desc-9':  'Halaman yang bersih, cepat, dan fokus — kesan pertama yang tak terlupakan.',
      'svc-name-10': 'Desain Sosial Media',
      'svc-desc-10': 'Konten visual yang menghentikan scroll dan berbicara untuk brand Anda.',
      'svc-name-11': 'UI Mockup',
      'svc-desc-11': 'Mockup UI resolusi tinggi yang menghidupkan visi produk Anda sebelum satu baris kode pun ditulis.',
      'section-skills':   '03 — Keahlian',
      'skills-title':     'Yang Membuat Saya Bisa Berkarya',
      'skills-sub':       'Alat yang saya gunakan setiap hari untuk mengubah ide menjadi hasil nyata.',
      'section-exp':      '04 — Pengalaman',
      'exp-title':        'Perjalanan Saya',
      'exp-sub':          'Setiap peran membentuk cara saya berpikir, membangun, dan memimpin.',
      'exp-present':      'Sekarang',
      'section-org':      '05 — Kepemimpinan',
      'org-title':        'Bukan Sekadar Jabatan',
      'org-sub':          'Lebih dari sekadar jabatan — saya membangun tim, menjalankan program, dan belajar cara manusia bekerja.',
      ...
      'section-achieve':  '06 — Pencapaian',
      'achieve-title':    'Hasil yang Berbicara',
      'achieve-sub':      'Beberapa momen di mana karya berbicara sendiri.',
      'section-edu':      '07 — Pendidikan',
      'edu-title':        'Dari Sini Saya Mulai',
      'edu-sub':          'Tempat rasa ingin tahu menjadi disiplin.',
      'section-works':    '08 — Karya Pilihan',
      'works-title':      'Dashboard & Tools yang Saya Buat',
      'section-portfolio':'09 — Portofolio',
      'portfolio-title':  'Saya Juga Desainer.',
      'portfolio-sub':    'UI/UX, identitas brand, sistem visual — dibuat dengan ketelitian yang sama seperti saya mengelola data.',
      'portfolio-link':   'Lihat di Behance ↗',
      'section-writing':  '10 — Tulisan',
      'writing-title':    'Yang Perlu Dibaca',
      'writing-sub':      'Tulisan panjang tentang desain, data, karier, dan hal-hal yang pernah saya alami.',
      'writing-link':     'Baca di Medium ↗',
      'section-videos':   '11 — Video',
      'videos-title':     'Langsung dari Saya',
      'videos-sub':       'Ketika tidak sedang membangun sesuatu, saya membicarakannya — produktivitas, orang, dan hidup.',
      'videos-link':      'Tonton di YouTube ↗',
      'section-techstack':'12 — Tech Stack',
      'techstack-title':  'Mesin di Balik Karya',
      'techstack-sub':    'Bukan sekadar alat — tapi pilihan yang saya percaya untuk menyelesaikan pekerjaan.',
      'section-contact':  '13 — Kontak',
      'contact-title':    'Kirimkan Pesanmu',
      'contact-sub':      'Proyek, kolaborasi, atau sekadar ngobrol — inbox saya selalu terbuka.',
      'exp-role-1':       'Stock Analyst & Distribution Supervisor',
  ...
  const i18nMap = {
    ...
    'section-services': '.services .section-label',
    'services-title':   '.services .section-title',
    'services-sub':     '.services .section-sub',
    'svc-name-2':  '[data-i18n="svc-name-2"]',
    'svc-desc-2':  '[data-i18n="svc-desc-2"]',
    'svc-name-4':  '[data-i18n="svc-name-4"]',
    'svc-desc-4':  '[data-i18n="svc-desc-4"]',
    'svc-name-5':  '[data-i18n="svc-name-5"]',
    'svc-desc-5':  '[data-i18n="svc-desc-5"]',
    'svc-name-6':  '[data-i18n="svc-name-6"]',
    'svc-desc-6':  '[data-i18n="svc-desc-6"]',
    'svc-name-7':  '[data-i18n="svc-name-7"]',
    'svc-desc-7':  '[data-i18n="svc-desc-7"]',
    'svc-name-9':  '[data-i18n="svc-name-9"]',
    'svc-desc-9':  '[data-i18n="svc-desc-9"]',
    'svc-name-10': '[data-i18n="svc-name-10"]',
    'svc-desc-10': '[data-i18n="svc-desc-10"]',
    'svc-name-11': '[data-i18n="svc-name-11"]',
    'svc-desc-11': '[data-i18n="svc-desc-11"]',
    'section-skills':   '.skills .section-label',
    'skills-title':     '.skills .section-title',
    'skills-sub':       '.skills .section-sub',
    'section-exp':      '.experience .section-label',
    'exp-title':        '.experience .section-title',
    'exp-sub':          '.experience .section-sub',
    'exp-present':      '[data-i18n="exp-present"]',
    'section-org':      '.org .section-label',
    'org-title':        '.org .section-title',
    'org-sub':          '.org .section-sub',
