...
(function () {
  const translations = {
    en: {
      ...
      'svc-desc-1':  'Ready-to-use templates in Excel, Power BI & Looker — built for real work.',
      'svc-name-2':  'Custom BI Dashboard',
      'svc-desc-2':  'Tailored dashboards in Power BI, Tableau, or Looker — turning raw data into clear decisions.',
      'svc-name-3':  'Power BI Online Course',
      'svc-desc-3':  '1-on-1 sessions designed around your pace, goals, and data.',
      'svc-name-4':  'Power BI Workshop',
      'svc-desc-4':  'Hands-on group or private sessions — from zero to dashboard in one day.',
    ...
    id: {
      ...
      'svc-desc-1':  'Template siap pakai di Excel, Power BI & Looker — dirancang untuk kerja nyata.',
      ...
      'svc-name-3':  'Kursus Online Power BI',
      'svc-desc-3':  'Sesi 1-on-1 yang dirancang sesuai kecepatan, tujuan, dan data Anda.',
      'svc-name-4':  'Workshop Power BI',
      'svc-desc-4':  'Sesi kelompok atau privat langsung praktik — dari nol hingga dashboard dalam satu hari.',
      'svc-name-5':  'Excel & Spreadsheet Custom',
