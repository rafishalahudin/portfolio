...
(function () {
  const translations = {
    en: {
      ...
      'exp-points-3':     '<li>Led production of promotional ads and visual content, creating up to 3 items per day.</li><li>Directed end-to-end printed materials production across 3 departments, achieving 80% design completion per request.</li>',
      'exp-role-4':       'Public Relation Intern',
      'exp-points-4':     '<li>Conducted media monitoring for Ditjen Vokasi and Ditjen Dikti, managing 50+ news items daily.</li><li>Developed and launched 3 websites and created 1 UX landing page for IMBEX 2023.</li><li>Designed internal audit for the Ministry of Communication and Informatics — 100+ page report.</li>',
      'exp-role-5':       'UX Designer Intern',
      'exp-points-5':     '<li>Revamped Kitabisa UI/UX news page — enhanced 30 frames for improved user experience.</li><li>Conceptualized and designed Liharama, an education app with 5+ features.</li>',
      'exp-role-6':       'Administrative Intern',
      'exp-points-6':     '<li>Conducted comprehensive design work (3/day) and internal quality audits for strategic decision-making.</li>',
