...
(function () {
  const translations = {
    ...
    id: {
      ...
      'exp-role-4':       'Public Relation Intern',
      'exp-points-4':     '<li>Melacak dan merangkum 50+ berita per hari dari Ditjen Vokasi dan Ditjen Dikti untuk menjaga akurasi liputan media.</li><li>Meluncurkan 3 website dan 1 landing page UX untuk IMBEX 2023 - dari konsep desain hingga deployment.</li><li>Menyusun laporan audit internal 100+ halaman untuk Kemenkominfo guna mendukung tinjauan kepatuhan strategis.</li>',
      'exp-role-5':       'UX Designer Intern',
      'exp-points-5':     '<li>Merombak UI/UX halaman berita Kitabisa - mendesain ulang 30 frame untuk menyederhanakan alur pengguna dan meningkatkan konsistensi visual.</li><li>Mengonsep dan merancang Liharama dari awal - aplikasi edukasi dengan 5+ fitur utama beserta dokumentasi UX lengkap.</li>',
      'exp-role-6':       'Administrative Intern',
      'exp-points-6':     '<li>Menghasilkan hingga 3 aset desain per hari sambil menjalankan audit kualitas internal untuk mendukung keputusan strategis berbasis data.</li>',
